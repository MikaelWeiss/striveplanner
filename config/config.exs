...
config :strive_planner,
  ecto_repos: [StrivePlanner.Repo],
...
config :strive_planner, StrivePlannerWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: StrivePlannerWeb.ErrorHTML, json: StrivePlannerWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: StrivePlanner.PubSub,
  live_view: [signing_salt: "Riw2y8DD"]
...
config :strive_planner, Oban,
  ...
  queues: [emails: [limit: 1, dispatch_cooldown: 500]],
  plugins: [
