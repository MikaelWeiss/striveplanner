...
# reCAPTCHA configuration (all environments)
config :strive_planner, :recaptcha,
  site_key: env!("RECAPTCHA_SITE_KEY", :string),
  secret_key: env!("RECAPTCHA_SECRET_KEY", :string)

# Resend email configuration (all environments)
config :strive_planner, :resend, api_key: env!("RESEND_API_KEY", :string)
